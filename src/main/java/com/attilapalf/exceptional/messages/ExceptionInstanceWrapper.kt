 ...
 */
public data class ExceptionInstanceWrapper(
        var fromWho: BigInteger = BigInteger.ZERO,
        var toWho: BigInteger = BigInteger.ZERO,
        var timeInMillis: Long = 0,
        var longitude: Double = 0.0,
        var latitude: Double = 0.0,
        var exceptionTypeId: Int = 0,
        var instanceId: BigInteger = BigInteger.ZERO,
